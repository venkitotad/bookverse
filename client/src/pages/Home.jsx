...
function Home() {
  return (
    <div className="min-h-screen flex flex-col-reverse lg:flex-row items-center justify-between px-6 lg:px-20 py-12 bg-white">
      {/* Left Content */}
      <div className="w-full lg:w-1/2 text-center lg:text-left space-y-6">
        <h1 className="text-4xl md:text-5xl font-extrabold leading-tight">
          Discover your <span className="text-orange-500">next</span> favorite book
          with <span className="text-stone-700">BookVerse</span>.
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center sm:justify-start gap-4 mt-6">
          <Link
            to="/signup"
            className="bg-stone-700 text-white px-6 py-3 rounded-xl hover:bg-stone-800 transition"
          >
            Get Started
          </Link>
          <Link

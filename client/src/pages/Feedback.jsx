...
function Feedback() {
  return (
    ...
    <>
    <form class="max-w-md mx-auto mt-20 p-6 bg-white  rounded-lg shadow-lg">
    ...
    <button class="bg-orange-500 hover:border-l-amber-300 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline cursor-pointer" type="submit">
    Submit
  </button>
</form>
